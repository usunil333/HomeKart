...
<a href="" id="printpagebutton" onclick="myFunction()"><B>Print</B></a>
		...
		<h3 class="one"><img src="img/homekart.jpg"  /><br/>Official Receipt<br /><font color="red"><U>UNPAID</U></font></h3>
		<div class="printtitle">
			<hr>
<b> The store is located at Balkumari,Lalitpur, Nepal <Br>
lalitpur, Nepal</b><hr></div>
		...
		<table border="" color="black">
			...
			$row4=mysql_fetch_array($query4);
				...
				echo '<td><div align="center">Rs '.formatMoney($row4['price'],2).'</div></td>';
				echo '<td><div align="center">'.$row3['Quantity'].'</div></td>';
				echo '<td><div align="center">Rs '.formatMoney($row3['Total'],2).'</div></td></tr>';
            ...
            <td><div align="center" ><strong>E-VAT 13%</strong></div></td>
            </tr>
            <tr>
            <td align='center'>Courier</td>
            <td >Rs 250.00</td>
            <td ><?php echo 'Rs '.formatMoney($tax,2); ?></td>
            </tr>
            <tr>
          ...
          while($row5 = mysql_fetch_array($result5))
            { 
             $total=250+$row5['sum(total)'];
            echo 'Rs '.formatMoney($total,2);
            }
          ?></td>
            </tr>
