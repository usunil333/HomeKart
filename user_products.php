...
?>
        ...
        <div class="caption">
          ...
          <h4><a class="btn btn-success" title="Click to view!" href="user_product_details.php?id=<?php echo $id;?>"><i class="icon-check"></i> VIEW</a> <span class="pull-right">Rs<?php echo formatMoney($row['price'],2); ?></span></h4>
        </div>
        </div>
      </li>
         <?php } ?>
