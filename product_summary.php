...
<html lang="en">
  <head>
    ...
    <title>HomaKart: An Online Store</title>
    ...
    <?php } ?>
         ...
         <tr>
          ...
          while($row5 = mysql_fetch_array($result5))
            { 
            echo "Rs".formatMoney($row5['sum(total)']);
...
<option value="Hetauda City">Hetauda</option>
<option value="Birgunj City">Birgunj</option>
<option value="Narayanghat City">Narayanghat</option>
<option value="Janakpur City">Janakpur</option>
<option value="Ilam City">Ilam</option>
<option value="Dharan City">Dharan</option>
<option value="Kathmandu City">Kathmandu</option>
<option value="Pokhara City">Pokhara</option>
<option value="Bharatpur City">Bharatpur</option>
<option value="Biratnagar City">Biratnagar</option>
<option value="Itahari City">Itahari</option>
<option value="Nepalgunj City">Nepalgunj</option>
<option value="Butwal City">Butwal</option>
<option value="Tadi City">Tadi</option>
<option value="Lalitpur City">Lalitpur</option>
<option value="Dhangadhi City">Dhangadhi</option>
</select> 
</form>
