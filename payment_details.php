...
<form action="https://esewa.com.np/home"  method="post">
<input type="hidden" name="cmd" value="_xclick" />
        ...
        <div class="container">
        <input type="image" src="esewa.jpg" border="0" name="submit" alt="Make payments with eSewa - it's fast, free and secure!"  />
		...
		<img  class="pull-left" src="esewaverified.jpg" /> 
        <h3>  We will dispatch and ship your products once the payment is made.For payment details.</h3>

        <h3>Store Name: HomeKart</br></h3>
        <h3>Thanks!</h3>
